...
const EmailSVG: FC<SVGProps> = ({ className }) => {
    return (
        <span className={ className }>
            <svg id='EmailSVG' className={`${className}-svg`} version='1.1'  xmlns='http://www.w3.org/2000/svg'
                x='0px' y='0px' viewBox='0 0 493.332 493.332'
            >
                <g id='XMLID_78_' >
                    <g id='XMLID_79_'>
                        <g id='XMLID_80_'>
