...
const PhoneSVG: FC<SVGProps> = ({ className }) => {
    return (
        <span className={ className }>
            <svg id='PhoneSVG' className={`${className}-svg`} version='1.1' xmlns='http://www.w3.org/2000/svg' x='0px'
                y='0px' width='558.833px' height='558.833px' viewBox='0 0 558.833 558.833'
            >
                <g>
                    <g>
